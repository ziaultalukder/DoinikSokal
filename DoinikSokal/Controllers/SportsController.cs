...
namespace DoinikSokal.Controllers
{
    public class SportsController : Controller
    {
        ...
        public SportsController(CategoryManager category, PostManager post)
        {
        ...
        public ActionResult Index()
        {
            ...
            var technologyPost = homePost.Where(c => c.Category.Name == "Sports");

            var datas = homePost.OrderByDescending(c => c.Id).FirstOrDefault(c => c.Category.Name == "Sports");
