...
namespace DoinikSokal.Controllers
{
    public class TechnologyController : Controller
    {
        ...
        public TechnologyController(CategoryManager category, PostManager post)
        {
        ...
        public ActionResult Index()
        {
            ...
            var technologyPost = homePost.Where(c => c.Category.Name == "Technology");

            var datas = homePost.OrderByDescending(c => c.Id).FirstOrDefault(c => c.Category.Name == "Technology");
            ...
            var latestPost = technologyPost.Skip(7).Take(27);
